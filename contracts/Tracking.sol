...
contract Tracking{
    ...
    function startShipment(address _sender, address _receiver, uint256 _deliveryTime, uint256 _index) public{
    ...
    function getShipment(address _sender, uint256 _index) public view returns (address, address, uint256, uint256, uint256, uint256, ShipmentStatus, bool){
        ...
        return (shipment.sender, shipment.receiver, shipment.pickTime, shipment.deliveryTime, shipment.distance, shipment.price, shipment.status, shipment.isPaid); 
    }
